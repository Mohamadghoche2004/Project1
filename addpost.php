...
include("./db_config/addpostaction.php");
                                    ...
                                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                                        <div class="card-body p-5 text-center">
                                            ...
                                            <div class="mb-md-5 mt-md-4 pb-5">
                                                ...
                                                <p class="text-white-50 mb-5">Create your post!</p>
                                                <form action="addpost.php" method="post" enctype="multipart/form-data">
                                                <div class="form-outline form-white mb-4">
                                                    <label class="form-label" for="textAreaExample">Description</label>
                                                    <div class="form-outline">
                                                    <input type="text" name="desc" id="form12" class="form-control"  />
                                                ...
                                                <button type="submit" class="btn btn-outline-light btn-lg px-5"  name="submit">Post
                                                </button>
                                                </form>
