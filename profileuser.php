...
if(mysqli_num_rows($result) > 0){
    ...
    header("location:home.php?error=no user found");
}


$query="SELECT COUNT(id) as countid FROM post WHERE user_id='$id'";
...
<body>
    ...
    <div class="container-fluid">
        <div class="row" align="center">
            <div class=" col-3 col-lg-2 col-xl-2 bg-dark ">
        ...
        <div class="container-fluid   " >
           ...
           ?>
                            ...
                            <a href="./editprofile.php">
                                <button type="button" class="btn btn-outline-dark mb-2 text-light " data-mdb-ripple-color="dark"
